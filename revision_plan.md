...
**State the limits of the study in the same subsection**, not only in §5: these are parametric models of systematics rather than instrument-derived; four of the seven requested validation axes are covered in full and three in part; and perturbed or reconfigured spectra from a given code remain spectra from that code.
