...
SWAP_DIRS = {"exomol": os.path.expanduser("~/opacity_swap_v2_exomol"),
             "exomol_o3": os.path.expanduser("~/opacity_swap_v2_exomol_o3")}
EXOMOL_MOL = {"1H2-16O": "H2O", "12C-1H4": "CH4", "12C-16O2": "CO2"}
