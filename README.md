...
Python 3.10 required (TensorFlow pin). All evaluation commands below run on **committed data** — no data generation, no external tools.
...
Expected: accuracy falls from 88.9% (in-domain, paired planets) to 84.8% under the independent RT code — the paper's Table 2, row 1.
