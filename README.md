...
| §4 Frequency content does not order repairability: the correlated noise is the smoothest of the five perturbations, 2 % of its power above an eighth of a cycle per bin against the haze's 11 %, and it repairs worst | `python frequency.py` | `results/ariel_frequency.txt` |
