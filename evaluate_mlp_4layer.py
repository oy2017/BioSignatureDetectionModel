...
# --- Argument Parser ---
parser = argparse.ArgumentParser(description="Rigid 4-Layer MLP on PCA Spectra.")
...
# --- 1. Load Data ---
print(f"--- Loading H2 Data for 4-Layer MLP ---")
...
# --- 3. Build Rigid 4-Layer Architecture ---
# Config: 512 -> 256 -> 128 -> 64
print("--- Building 4-Layer MLP [512, 256, 128, 64] ---")
model = Sequential([
...
# --- 6. Save Report ---
report_name = f'best_mlp_4layer_report.txt'
